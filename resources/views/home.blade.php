                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('users.update' , $user->email) }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="mid_initial" type="text" class="form-control @error('mid_initial') is-invalid @enderror" name="mid_initial" value="{{$user->mid_initial}}" autocomplete="mid_initial" autofocus>
                                @error('mid_initial')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="zip" type="text" class="form-control @error('zip_code') is-invalid @enderror" name="zip_code" value="{{ $user->zip_code}}" autocomplete="zip" autofocus>
                                @error('zip_code')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
